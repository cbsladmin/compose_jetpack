...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            val inputvalue = remember { mutableStateOf("Change Button Test") }
            ...
            ScrollableColumn {
                ...
                ButtonComponentMY(
                    ...
                    buttonText = inputvalue.value,
                    valuetyoe = inputvalue
                )
...
@Composable
fun ButtonComponentMY(
    context: Context,
    intent: Intent,
    buttonText: String,
    valuetyoe: MutableState<String>
) {
    Button(
        onClick = {
            valuetyoe.value = "sdfsdfsdf"
        },
        modifier = Modifier
            .padding(16.dp)
            .fillMaxWidth(),
